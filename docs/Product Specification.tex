...
\begin{itemize}
	\item AI (easy) should make move after 1 second.
	\item AI (mediums) should make move after 3 seconds.
	\item User interface should be simple to use
	\item User graphics should be clean and comfortable to look at
	\item Easily expandable code
	\item Code that is easily understandable
	\item Code should have good documentation
	\item All used graphics should have open licence
\end{itemize}
